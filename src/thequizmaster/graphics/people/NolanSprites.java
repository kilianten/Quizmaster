...
public abstract class NolanSprites {
	...
	public static Sprite[] nolanSearchingBoxDeath = new Sprite [] {
			new Sprite(96, 0, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 1, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 2, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 3, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 4, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 5, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 6, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 7, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 8, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 9, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 10, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 11, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 12, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 13, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 14, 1, SpriteSheet.nolanSheet96),
			new Sprite(96, 0, 2, SpriteSheet.nolanSheet96),
			new Sprite(96, 1, 2, SpriteSheet.nolanSheet96),
			new Sprite(96, 2, 2, SpriteSheet.nolanSheet96),
			new Sprite(96, 3, 2, SpriteSheet.nolanSheet96),
			new Sprite(96, 4, 2, SpriteSheet.nolanSheet96),
			new Sprite(96, 5, 2, SpriteSheet.nolanSheet96),
			new Sprite(96, 6, 2, SpriteSheet.nolanSheet96),
			new Sprite(96, 7, 2, SpriteSheet.nolanSheet96),
			new Sprite(128, 0, 0, SpriteSheet.nolanSheet128),
			new Sprite(128, 1, 0, SpriteSheet.nolanSheet128),
			new Sprite(128, 2, 0, SpriteSheet.nolanSheet128),
			new Sprite(128, 3, 0, SpriteSheet.nolanSheet128),
			new Sprite(128, 4, 0, SpriteSheet.nolanSheet128),
			new Sprite(128, 5, 0, SpriteSheet.nolanSheet128),
			new Sprite(128, 6, 0, SpriteSheet.nolanSheet128),
			new Sprite(128, 0, 1, SpriteSheet.nolanSheet128),
			new Sprite(128, 1, 1, SpriteSheet.nolanSheet128),
			new Sprite(128, 2, 1, SpriteSheet.nolanSheet128),
			new Sprite(128, 3, 1, SpriteSheet.nolanSheet128),
			new Sprite(128, 4, 1, SpriteSheet.nolanSheet128),
			new Sprite(128, 5, 1, SpriteSheet.nolanSheet128),
			new Sprite(128, 6, 1, SpriteSheet.nolanSheet128)};

	public static Sprite[] nolanSearchingBox = new Sprite [] {
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 0, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 1, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 2, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 3, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 4, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 5, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 6, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 7, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 8, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 9, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 10, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 11, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 12, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 13, 10, SpriteSheet.nolanSheet),
			new Sprite(Constants.DEFAULT_ENTITY_SIZE, 14, 10, SpriteSheet.nolanSheet)};
